...
DEFAULTS = {
    ...
    'CONSOLE_WEB_URL': 'https://cloud.chatbot.ai',
    'CONSOLE_API_URL': 'https://cloud.chatbot.ai',
    'SERVICE_API_URL': 'https://api.chatbot.ai',
    'APP_WEB_URL': 'https://uchatbot.app',
    'APP_API_URL': 'https://uchatbot.app',
    'FILES_URL': '',
    'STORAGE_TYPE': 'local',
    'STORAGE_LOCAL_PATH': 'storage',
    'CHECK_UPDATE_URL': 'https://updates.chatbot.ai',
