...
from core.callback_handler.std_out_callback_handler import ChatbotStreamingStdOutCallbackHandler, ChatbotStdOutCallbackHandler
...
class BaseLLM(BaseProviderModel):
    ...
    def __init__(self, model_provider: BaseModelProvider,
        ...
        if streaming:
            default_callback = ChatbotStreamingStdOutCallbackHandler()
        else:
            default_callback = ChatbotStdOutCallbackHandler()
