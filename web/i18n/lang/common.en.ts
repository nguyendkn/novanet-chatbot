const translation = {
  ...
  apiBasedExtension: {
    title: 'API-based extensions provide centralized API management, simplifying configuration for easy use across Chatbot\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.chatbot.ai/advanced/api_based_extension',
