const translation = {
  ...
  desc: 'Here you can mochatbot the properties and working methods of the dataset.',
  form: {
    name: 'Dataset Name',
    ...
    descPlaceholder: 'Describe what is in this data set. A detailed description allows AI to access the content of the data set in a timely manner. If empty, Chatbot will use the default hit strategy.',
