...
const CustomizeModal: FC<IShareLinkProps> = ({
  ...
  >
    <div className='w-full mt-4 px-6 py-5 border-gray-200 rounded-lg border-[0.5px]'>
      ...
      <div className='flex py-4'>
        ...
        <div className='flex flex-col'>
          ...
          <a href={`https://github.com/nguyendkn/${isChatApp ? 'webapp-conversation' : 'webapp-text-generator'}`} target='_blank'>
      ...
      <div className='flex py-4'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <pre className='box-border py-3 px-4 bg-gray-100 text-xs font-medium rounded-lg select-text'>
            ...
            NEXT_PUBLIC_APP_KEY={'\'<Web API Key From Chatbot>\''} <br />
    ...
    <div className='w-full mt-4 px-6 py-5 border-gray-200 rounded-lg border-[0.5px]'>
      ...
      <Button
        className='w-36 mt-2'
        onClick={() => window.open(`https://docs.chatbot.ai/${locale === 'en' ? '' : `v/${locale.toLowerCase()}`}/application/developing-with-apis`, '_blank')}
      >
