        ...
        <div className="bg-white">
                ...
                htmlContent={
                  <div className='w-[256px] text-xs font-medium'>
                    ...
                    <div className='text-xs font-medium cursor-pointer text-primary-600'>
                      <a href="mailto:request-invitation@novaon.asia">request-invitation@novaon.asia</a>
                    </div>
                  </div>
                }
              >
          ...
          <div className="block w-hull mt-2 text-xs text-gray-600">
            ...
            <Link
              ...
              target={'_blank'}
              href={`https://docs.chatbot.ai/${locale === 'en' ? '' : `v/${locale.toLowerCase()}`}/community/open-source`}
